...
export class CampamentoComponent implements OnInit {
  textos = {
    esp: {
      ...
      texto13: "Una vez realizado el pago envíanos tu comprobante a pagos@ranchoaventuramexico.com indicando nombre completo del acampador. Tu pago se verá reflejado en nuestro sistema en un lapso de 48 horas hábiles.",
    ...
    eng: {
      ...
      texto13: "Once the payment is made, send us your receipt to pagos@ranchoaventuramexico.com indicating the camper's full name. Your payment will be reflected in our system within 48 business hours.",
