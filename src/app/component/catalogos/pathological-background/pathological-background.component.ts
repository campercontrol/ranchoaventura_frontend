...
@Component({
  ...
  styleUrls: ['./pathological-background.component.scss']
})
export class PathologicalBackgroundComponent implements OnInit {
  ...
  getCatalogos() {
    this.catalogos.getPathological_background().subscribe((res: any) => {
