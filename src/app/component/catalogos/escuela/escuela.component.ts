...
export class EscuelaComponent implements OnInit {
  ...
  phone: ['', [Validators.required, Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(10)]],
  cellphone: ['', [Validators.required, Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(10)]],
  email: ['', [Validators.required,Validators.email]],
  contact_second_name: ['', [Validators.required,Validators.minLength(2)]],
  contact_second_phone: ['', [Validators.required, Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(10)]],
  contact_second_cellphone:['', [Validators.required, Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(10)]],
  contact_second_email:['', [Validators.required,Validators.email]],
  contact_third_name: ['', [Validators.required,Validators.minLength(2)]],
  contact_third_phone:['', [Validators.required, Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(10)]],
  contact_third_cellphone: ['', [Validators.required, Validators.pattern("^[0-9]*$"),Validators.minLength(8), Validators.maxLength(10)]],
  contact_third_email: ['', [Validators.required,Validators.email]],
  verify: [true],
  active: [true],
    })
  }
