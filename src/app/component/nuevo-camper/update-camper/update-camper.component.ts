...
export class UpdateCamperComponent implements OnInit {
  ...
  placeholder={
    "eng":{
      ...
      leyenda1:"RANCHO AVENTURA has minor accident insurance with AIG México. If medical expenses exceed the insured amount, the costs will be covered by the parents or the camper's major medical insurance (if available). Check your camp details for insured amounts and insurance features.",
