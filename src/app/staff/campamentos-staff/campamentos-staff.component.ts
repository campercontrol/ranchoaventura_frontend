  ...
  this.capms.getReportesGenerales(this.idCamp).subscribe({
    next: (response: any) => {
      ...
      const headersMap: any = {
        ...
        'Epilepsia / Epilepsy': 'Epilepsia', 
        'Migraña / Migraine': 'Migraña',
        'Hipotension/ Hypotension': 'Hipotension',
        'Rinitis / Rhinitis': 'Rinitis',
        'Soplo cardiaco / Heart murmur': 'Soplo cardiaco',
        'Antecedentes de infarto / History of heart attack': 'Antecedentes de infarto',
        'Kosher': 'Kosher',
        ...
        'neumococo / pneumococcal vaccine': 'neumococo',
        'tuberculosis / tuberculosis vaccine': 'tuberculosis',
        'tetanos / tetanus vaccine': 'tetanos',
        'hepatitis / hepatitis vaccine': 'hepatitis',
        'Influenza': 'Influenza',
        'Sarampión / Measles': 'Sarampión',
        'Ibuprofeno - Motrin - Ibuprofen': 'Ibuprofeno - Motrin - Ibuprofen',
        'Butilhioscina - Buscapina - Butylhyoscine': 'Butilhioscina - Buscapina - Butylhyoscine',
        'Dimenhidrinato - Dramamine - Dimenhydrinate': 'Dimenhidrinato - Dramamine - Dimenhydrinate',
        'Neomicina - Treda - Neomycin': 'Neomicina - Treda - Neomycin',
        'Anthistamínico - Celestamine - Antihistamine': 'Anthistamínico - Celestamine - Antihistamine',
        'Paracetamol': 'Paracetamol',
        'Solución oftálmica - Ocular solution': 'Solución oftálmica',
        'Salicato de Bismuto - Pepto Bismol - Bismuth Subgallate': 'Salicato de Bismuto - Pepto Bismol - Bismuth Subgallate',
        ...
        'Camper extra questions': 'Preguntas extra del camper',
        'enrollment': 'Estatus de inscripción'
      };
