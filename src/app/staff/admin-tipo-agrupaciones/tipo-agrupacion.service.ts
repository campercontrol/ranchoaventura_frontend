...
export class AdmitipoAgrupacionesService {
  ...
  postAgrupaciones(data:any){
    return this.http.post('https://api.ranchoaventuramexico.com/grouping_types/',data)
  }

  updateAgrupaciones(info:any,id){
    return this.http.put('https://api.ranchoaventuramexico.com/grouping_types/'+id,info)
  }

  deletGruping(id){
    return this.http.delete('https://api.ranchoaventuramexico.com/grouping_types/'+id)
